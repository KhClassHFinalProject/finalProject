...
<head>
	...
	<script type="text/javascript">
		$(function() {
			...
			$("#abList>ul").remove();
			$("#emList").addClass("open").children("ul").show();
			
			/*사이드바 메뉴 클릭*/
			$("#emList>ul>li>a").click(
				function(event) {
					detailSubject="";
					detailWrite="";
					detailPub="";
			...
			function ebookSearchAjax(simpleSearchText, page, orderName) {
				$.ajax({
					...
					, data : {simpleSearchText : simpleSearchText, page : page, orderName : orderName, idxParam : "EM"}
					, dataType : "json"
					, success : function(data){
			...
			function ebookDetailAjax(detailSubject, detailWrite, detailPub, cateLg, cateMd, page, orderName) {
				...
				$.ajax({
					...
					, data : {detailSubject : detailSubject , detailWrite : detailWrite , detailPub : detailPub , cateLg : cateLg , cateMd : cateMd , page : page, orderName : orderName, idxParam : "EM"}
					, dataType : "json"
					, success: function(data){
						var arr=data.elibArr;
						var intoHTML="";
		...
		/*처음 미검색 Ajax*/
		function ebookListFirst(page, orderName) {
			$.ajax({
				type : "GET"
				, url : "elibFirst.ju"
				, data : {page : page, orderName : orderName, idxParam : "EM"}
				, dataType : "json"
				, success: function(data){
					var arr=data.elibArr;
					var intoHTML="";
